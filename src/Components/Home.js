  ...
  return (
    <div className="home">
      <div className="home__container">
        ...
        <div className="home__welcome__container">
          <p className="home__text home__left home__one">
          ...
          <p className="home__text home__right home__two">
            “Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.”
          </p>

          <p className="home__text home__left home__three">
          ...
          <p className="home__text home__right home__four">
